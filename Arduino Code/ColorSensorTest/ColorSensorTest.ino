...
// BLUE-channel threshold (no ML model). Prints the ambient-subtracted RGBC and
...
// FRONT) shows its BLACK back to the sensor -> LOW BLUE channel; an OFF disc
...
void loop() {
  ...
  const char* guess = classifyDisc(b) ? "cyan" : "black";
