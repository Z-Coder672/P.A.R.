...
//
// Lidar standoff compensation is applied to EVERY cell (LIDAR_COMP_MODE 1).
// The masked half-board A/B variant lives in FlipAllMaskedTest.ino — use that
// one when measuring whether the compensation helps, this one for real runs.
